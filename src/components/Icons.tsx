/** 轻量线性图标（Lucide 风格，stroke = currentColor，随主题与 hover 变色） */

interface IconProps {
  /** 正方形边长（px），默认 13 与会话行小图标字号一致 */
  size?: number;
  className?: string;
}
...
/** 统计柱状图 */
export function BarChartIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 返回 */
export function BackIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 会话置顶/取消置顶图钉（一个图标两种语义，靠 title 提示区分） */
...
export function EyeOffIcon({ size = 13, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-4.333 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143" />
      <path d="m2 2 20 20" />
    </svg>
  );
}
...
/** 文件夹加号（批量添加） */
export function FolderPlusIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 三点更多（⋯） */
export function MoreIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 上折角（收起下拉指示） */
export function ChevronUpIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 空心圆（提问卡 tab 的「未答」标记；与 CheckIcon 配对成勾/圈） */
export function CircleIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 展开（方案卡「放大看全文」；Lucide maximize-2：两枚向外的对角箭头） */
export function ExpandIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 收起（与 ExpandIcon 成对；Lucide minimize-2） */
export function CollapseIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 侧栏收起/展开（Lucide panel-left，顶栏最左的项目列表开关） */
export function PanelLeftIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 向下箭头（加载更晚） */
export function ArrowDownIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 带文字的文档（工具结果卡；轮廓与 FileIcon 同源保持同屏一致） */
export function FileTextIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 三角警告（工具出错 / 状态警告） */
export function TriangleAlertIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 差异文档（diff 卡；轮廓与 FileIcon 同源保持同屏一致） */
export function FileDiffIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 对话气泡（查看器空态） */
export function MessageCircleIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** 笔记本（会话无内容空态） */
export function NotebookTextIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
